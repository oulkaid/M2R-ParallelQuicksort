...
|---------------|--------|--------------|---------|----------|-----------|
| 1 (Virtual)   | 4      | 1            | 2370    | 8000000  | 11000000  |
| 2 (Physical)  | 4      | 2            | 1346    | 600000   | 600000    |
| 3 (Physcial)  | 6      | 1            | 3000    | 360000   | 460000    |
"
...
#df$fact = factor(df$fact, levels=c('virtual','physical1','physical2'))
...
ggplot(mdf, aes(x = machine, y=value)) + 
  ...
  #scale_y_continuous(breaks=c(0, 8000000, 11000000, 600000, 360000, 460000))
```
